...
class User extends CActiveRecord
{
	...
	public function scopes()
    {
        return array(
            ...
            'notsafe'=>array(
            	'select' => 'id, username, password, email, activkey, createtime, lastvisit, superuser, status, role',
            ),
        );
    }
    ...
    {
        return array(
            'select' => 'id, username, email, createtime, lastvisit, superuser, status, role',
        );
    }
	...
	public static function itemAlias($type,$code=NULL) {
        ...
        protected function afterSave() { //TODO: Added by marcius
