...
class TransazioneEx extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('anno_registrazione', 'length', 'max'=>11),
        ...
        public static function listByYear($year)
	{
		...
		$criteria->compare('anno_registrazione', $year, true);
                $criteria->order = 'anno_registrazione, tipo_transazione, id_causale, descrizione';
